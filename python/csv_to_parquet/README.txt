...
Before you begin:
    1. Ensure your tenant is configured according to the instructions here: https://docs.cloud.oracle.com/en-us/iaas/data-flow/using/dfs_getting_started.htm#set_up_admin
    2. Know your object store namespace.
    3. Know the OCID of a compartment where you want to load your data and create applications.
    4. (Optional, strongly recommended): Install Spark to test your code locally before deploying.
...
Instructions:
    ...
    7. Create a Python Data Flow application pointing to csv_to_parquet.py
      7a. Refer to https://docs.cloud.oracle.com/en-us/iaas/data-flow/using/dfs_data_flow_library.htm#create_pyspark_app
